...
- `bank` (`Object`, optional): Holds the bank account details of the customer to charge
...
**Endpoint:** `POST /charge/submit_pin`
...
**Endpoint:** `POST /charge/submit_otp`
...
**Endpoint:** `POST /charge/submit_phone`
...
**Endpoint:** `POST /charge/submit_birthday`
...
**Endpoint:** `POST /charge/submit_address`
