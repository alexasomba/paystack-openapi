...
type _SplitCreateResponseData SplitCreateResponseData
...
func (o *SplitCreateResponseData) UnmarshalJSON(data []byte) (err error) {
	...
	varSplitCreateResponseData := _SplitCreateResponseData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSplitCreateResponseData)

	if err != nil {
		return err
	}

	*o = SplitCreateResponseData(varSplitCreateResponseData)
