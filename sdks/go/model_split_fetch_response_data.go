...
type _SplitFetchResponseData SplitFetchResponseData
...
func (o *SplitFetchResponseData) UnmarshalJSON(data []byte) (err error) {
	...
	varSplitFetchResponseData := _SplitFetchResponseData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSplitFetchResponseData)

	if err != nil {
		return err
	}

	*o = SplitFetchResponseData(varSplitFetchResponseData)
