...
func (o *StorefrontListResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varStorefrontListResponse := _StorefrontListResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varStorefrontListResponse)

	if err != nil {
		return err
	}

	*o = StorefrontListResponse(varStorefrontListResponse)
