...
func (o *PaymentRequestListResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varPaymentRequestListResponse := _PaymentRequestListResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPaymentRequestListResponse)

	if err != nil {
		return err
	}

	*o = PaymentRequestListResponse(varPaymentRequestListResponse)
