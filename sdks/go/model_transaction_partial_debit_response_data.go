...
var _ MappedNullable = &TransactionPartialDebitResponseData{}

// TransactionPartialDebitResponseData struct for TransactionPartialDebitResponseData
type TransactionPartialDebitResponseData struct {
...
func (o TransactionPartialDebitResponseData) MarshalJSON() ([]byte, error) {
...
func (o TransactionPartialDebitResponseData) ToMap() (map[string]interface{}, error) {
...
type NullableTransactionPartialDebitResponseData struct {
	value *TransactionPartialDebitResponseData
	isSet bool
}

func (v NullableTransactionPartialDebitResponseData) Get() *TransactionPartialDebitResponseData {
	return v.value
}

func (v *NullableTransactionPartialDebitResponseData) Set(val *TransactionPartialDebitResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableTransactionPartialDebitResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableTransactionPartialDebitResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTransactionPartialDebitResponseData(val *TransactionPartialDebitResponseData) *NullableTransactionPartialDebitResponseData {
	return &NullableTransactionPartialDebitResponseData{value: val, isSet: true}
}

func (v NullableTransactionPartialDebitResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTransactionPartialDebitResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
