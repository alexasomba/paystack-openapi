...
type _SplitListResponseArray SplitListResponseArray
...
func (o *SplitListResponseArray) UnmarshalJSON(data []byte) (err error) {
	...
	varSplitListResponseArray := _SplitListResponseArray{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSplitListResponseArray)

	if err != nil {
		return err
	}

	*o = SplitListResponseArray(varSplitListResponseArray)
