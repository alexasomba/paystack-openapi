...
type _OrderListResponseMeta OrderListResponseMeta
...
func (o *OrderListResponseMeta) UnmarshalJSON(data []byte) (err error) {
	...
	varOrderListResponseMeta := _OrderListResponseMeta{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varOrderListResponseMeta)

	if err != nil {
		return err
	}

	*o = OrderListResponseMeta(varOrderListResponseMeta)
