...
func Test_paystack_DedicatedVirtualAccountAPIService(t *testing.T) {
	...
	t.Run("Test DedicatedVirtualAccountAPIService DedicatedAccountAssign", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		resp, httpRes, err := apiClient.DedicatedVirtualAccountAPI.DedicatedAccountAssign(context.Background()).Execute()
	...
	t.Run("Test DedicatedVirtualAccountAPIService DedicatedAccountDeactivate", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.DedicatedVirtualAccountAPI.DedicatedAccountDeactivate(context.Background(), id).Execute()
	...
	t.Run("Test DedicatedVirtualAccountAPIService DedicatedAccountFetch", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.DedicatedVirtualAccountAPI.DedicatedAccountFetch(context.Background(), id).Execute()
	...
	t.Run("Test DedicatedVirtualAccountAPIService DedicatedAccountRequery", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		resp, httpRes, err := apiClient.DedicatedVirtualAccountAPI.DedicatedAccountRequery(context.Background()).Execute()
