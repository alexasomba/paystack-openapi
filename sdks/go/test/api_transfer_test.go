...
func Test_paystack_TransferAPIService(t *testing.T) {
	...
	t.Run("Test TransferAPIService TransferExportTransfer", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		resp, httpRes, err := apiClient.TransferAPI.TransferExportTransfer(context.Background()).Execute()
