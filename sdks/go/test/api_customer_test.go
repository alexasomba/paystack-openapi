...
func Test_paystack_CustomerAPIService(t *testing.T) {
	...
	t.Run("Test CustomerAPIService CustomerDirectDebitActivationCharge", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var id int32

		resp, httpRes, err := apiClient.CustomerAPI.CustomerDirectDebitActivationCharge(context.Background(), id).Execute()
	...
	t.Run("Test CustomerAPIService CustomerFetchMandateAuthorizations", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var id int32

		resp, httpRes, err := apiClient.CustomerAPI.CustomerFetchMandateAuthorizations(context.Background(), id).Execute()
	...
	t.Run("Test CustomerAPIService CustomerInitializeAuthorization", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		resp, httpRes, err := apiClient.CustomerAPI.CustomerInitializeAuthorization(context.Background()).Execute()
	...
	t.Run("Test CustomerAPIService CustomerInitializeDirectDebit", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var id int32

		resp, httpRes, err := apiClient.CustomerAPI.CustomerInitializeDirectDebit(context.Background(), id).Execute()
	...
	t.Run("Test CustomerAPIService CustomerVerifyAuthorization", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var reference string

		resp, httpRes, err := apiClient.CustomerAPI.CustomerVerifyAuthorization(context.Background(), reference).Execute()
