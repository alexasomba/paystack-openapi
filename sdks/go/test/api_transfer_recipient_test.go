...
func Test_paystack_TransferRecipientAPIService(t *testing.T) {
	...
	t.Run("Test TransferRecipientAPIService TransferrecipientDelete", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var code string

		resp, httpRes, err := apiClient.TransferRecipientAPI.TransferrecipientDelete(context.Background(), code).Execute()
	...
	t.Run("Test TransferRecipientAPIService TransferrecipientUpdate", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var code string

		resp, httpRes, err := apiClient.TransferRecipientAPI.TransferrecipientUpdate(context.Background(), code).Execute()
