...
func (o *TransferRecipientListResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varTransferRecipientListResponse := _TransferRecipientListResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTransferRecipientListResponse)

	if err != nil {
		return err
	}

	*o = TransferRecipientListResponse(varTransferRecipientListResponse)
