...
func NewSubscriptionListResponse(status bool, message string, data []SubscriptionListResponseArray, meta Meta) *SubscriptionListResponse {
...
func (o *SubscriptionListResponse) GetMeta() Meta {
	if o == nil {
		var ret Meta
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *SubscriptionListResponse) GetMetaOk() (*Meta, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Meta, true
...
func (o *SubscriptionListResponse) SetMeta(v Meta) {
	o.Meta = v
}
