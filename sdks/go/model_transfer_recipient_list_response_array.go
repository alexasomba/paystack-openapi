...
type _TransferRecipientListResponseArray TransferRecipientListResponseArray
...
func NewTransferRecipientListResponseArray(active bool, createdAt string, currency string, domain string, id int32, name string, recipientCode string, type_ string, updatedAt string, details TransferRecipientListResponseArrayDetails) *TransferRecipientListResponseArray {
...
func (o *TransferRecipientListResponseArray) HasDescription() bool {
...
func (o *TransferRecipientListResponseArray) SetDescriptionNil() {
	o.Description.Set(nil)
}

// UnsetDescription ensures that no value is present for Description, not even an explicit nil
func (o *TransferRecipientListResponseArray) UnsetDescription() {
	o.Description.Unset()
}
...
func (o *TransferRecipientListResponseArray) HasEmail() bool {
...
func (o *TransferRecipientListResponseArray) SetEmailNil() {
	o.Email.Set(nil)
}
...
func (o *TransferRecipientListResponseArray) HasIntegration() bool {
	if o != nil && !IsNil(o.Integration) {
		return true
	}
...
func (o *TransferRecipientListResponseArray) HasIsDeleted() bool {
	if o != nil && !IsNil(o.IsDeleted) {
		return true
	}
...
func (o *TransferRecipientListResponseArray) UnmarshalJSON(data []byte) (err error) {
	...
	varTransferRecipientListResponseArray := _TransferRecipientListResponseArray{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTransferRecipientListResponseArray)

	if err != nil {
		return err
	}

	*o = TransferRecipientListResponseArray(varTransferRecipientListResponseArray)
