...
type _DedicatedNubanFetchResponseData DedicatedNubanFetchResponseData
...
func (o *DedicatedNubanFetchResponseData) UnmarshalJSON(data []byte) (err error) {
	...
	varDedicatedNubanFetchResponseData := _DedicatedNubanFetchResponseData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDedicatedNubanFetchResponseData)

	if err != nil {
		return err
	}

	*o = DedicatedNubanFetchResponseData(varDedicatedNubanFetchResponseData)
