...
func (o *TerminalListsResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varTerminalListsResponse := _TerminalListsResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTerminalListsResponse)

	if err != nil {
		return err
	}

	*o = TerminalListsResponse(varTerminalListsResponse)
