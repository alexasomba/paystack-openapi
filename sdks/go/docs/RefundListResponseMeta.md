...
GetFailedRefundCount returns the FailedRefundCount field if non-nil, zero value otherwise.

### GetFailedRefundCountOk

`func (o *RefundListResponseMeta) GetFailedRefundCountOk() (*int32, bool)`

GetFailedRefundCountOk returns a tuple with the FailedRefundCount field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetFailedRefundCount
