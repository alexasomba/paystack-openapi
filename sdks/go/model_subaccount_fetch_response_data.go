...
type _SubaccountFetchResponseData SubaccountFetchResponseData
...
func (o *SubaccountFetchResponseData) UnmarshalJSON(data []byte) (err error) {
	...
	varSubaccountFetchResponseData := _SubaccountFetchResponseData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSubaccountFetchResponseData)

	if err != nil {
		return err
	}

	*o = SubaccountFetchResponseData(varSubaccountFetchResponseData)
