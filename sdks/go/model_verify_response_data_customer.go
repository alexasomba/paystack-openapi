...
func (o *VerifyResponseDataCustomer) UnmarshalJSON(data []byte) (err error) {
	...
	varVerifyResponseDataCustomer := _VerifyResponseDataCustomer{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varVerifyResponseDataCustomer)

	if err != nil {
		return err
	}

	*o = VerifyResponseDataCustomer(varVerifyResponseDataCustomer)
