---
name: axios-transport
description: Use when customizing @alexasomba/paystack-axios Axios transport, createAxiosFetch behavior, axiosInstance, axiosConfig, interceptors, cancellation, or Axios-based tests.
license: MIT
