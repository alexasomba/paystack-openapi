...
description: Use when testing or customizing @alexasomba/paystack-browser transport behavior with custom fetch, baseUrl, public-key auth, browser mocks, timeouts, or retries.
license: MIT
