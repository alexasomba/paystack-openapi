...
class RefundFetchResponseData(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RefundFetchResponseData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RefundFetchResponseData:
        """Create an instance of RefundFetchResponseData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RefundFetchResponseData.parse_obj(obj)

        _obj = RefundFetchResponseData.parse_obj({
            ...
            "customer": RefundFetchResponseDataCustomer.from_dict(obj.get("customer")) if obj.get("customer") is not None else None,
