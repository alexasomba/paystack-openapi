...
class ChargeAuthorizationResponseDataAuthorization(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ChargeAuthorizationResponseDataAuthorization:
        """Create an instance of ChargeAuthorizationResponseDataAuthorization from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ChargeAuthorizationResponseDataAuthorization:
        """Create an instance of ChargeAuthorizationResponseDataAuthorization from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ChargeAuthorizationResponseDataAuthorization.parse_obj(obj)

        _obj = ChargeAuthorizationResponseDataAuthorization.parse_obj({
