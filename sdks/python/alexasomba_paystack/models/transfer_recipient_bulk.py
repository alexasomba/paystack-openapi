...
class TransferRecipientBulk(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        _items = []
        if self.batch:
            for _item_batch in self.batch:
                if _item_batch:
                    _items.append(_item_batch.to_dict())
            _dict['batch'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "batch": [TransferRecipientCreate.from_dict(_item) for _item in obj["batch"]] if obj.get("batch") is not None else None
        })
        return _obj
