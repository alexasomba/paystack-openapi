...
class DisputeFetchResponseDataTransactionCustomer(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DisputeFetchResponseDataTransactionCustomer:
        """Create an instance of DisputeFetchResponseDataTransactionCustomer from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DisputeFetchResponseDataTransactionCustomer:
        """Create an instance of DisputeFetchResponseDataTransactionCustomer from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DisputeFetchResponseDataTransactionCustomer.parse_obj(obj)

        _obj = DisputeFetchResponseDataTransactionCustomer.parse_obj({
