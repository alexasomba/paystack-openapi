...
class TransferListResponseArrayRecipientDetails(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TransferListResponseArrayRecipientDetails:
        """Create an instance of TransferListResponseArrayRecipientDetails from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TransferListResponseArrayRecipientDetails:
        """Create an instance of TransferListResponseArrayRecipientDetails from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TransferListResponseArrayRecipientDetails.parse_obj(obj)

        _obj = TransferListResponseArrayRecipientDetails.parse_obj({
