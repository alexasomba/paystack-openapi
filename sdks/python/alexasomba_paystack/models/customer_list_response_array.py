...
class CustomerListResponseArray(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["integration", "first_name", "last_name", "email", "phone", "metadata", "domain", "customer_code", "risk_action", "id", "createdAt", "updatedAt"]
