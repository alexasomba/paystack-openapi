...
class OrderValidateResponseDataIntegration(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OrderValidateResponseDataIntegration:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OrderValidateResponseDataIntegration:
        """Create an instance of OrderValidateResponseDataIntegration from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OrderValidateResponseDataIntegration.parse_obj(obj)

        _obj = OrderValidateResponseDataIntegration.parse_obj({
            "key": obj.get("key"),
            "name": obj.get("name"),
            "logo": obj.get("logo"),
            "allowed_currencies": obj.get("allowed_currencies")
        })
        return _obj
