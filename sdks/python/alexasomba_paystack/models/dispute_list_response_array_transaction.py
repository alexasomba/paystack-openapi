...
class DisputeListResponseArrayTransaction(BaseModel):
    """
    ...
    __properties = ["id", "domain", "status", "reference", "amount", "message", "gateway_response", "paid_at", "created_at", "channel", "currency", "ip_address", "metadata", "log", "fees", "fees_split", "authorization", "customer", "plan", "subaccount", "split", "order_id", "pos_transaction_data", "source", "fees_breakdown", "connect"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DisputeListResponseArrayTransaction:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DisputeListResponseArrayTransaction:
        """Create an instance of DisputeListResponseArrayTransaction from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DisputeListResponseArrayTransaction.parse_obj(obj)

        _obj = DisputeListResponseArrayTransaction.parse_obj({
            "id": obj.get("id"),
