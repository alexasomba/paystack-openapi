...
class PaymentRequestListResponseArray(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PaymentRequestListResponseArray:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PaymentRequestListResponseArray:
        """Create an instance of PaymentRequestListResponseArray from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PaymentRequestListResponseArray.parse_obj(obj)

        _obj = PaymentRequestListResponseArray.parse_obj({
            "id": obj.get("id"),
