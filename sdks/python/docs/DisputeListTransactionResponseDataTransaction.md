...
dispute_list_transaction_response_data_transaction_instance = DisputeListTransactionResponseDataTransaction.from_json(json)
# print the JSON string representation of the object
print DisputeListTransactionResponseDataTransaction.to_json()

# convert the object into a dict
dispute_list_transaction_response_data_transaction_dict = dispute_list_transaction_response_data_transaction_instance.to_dict()
